namespace PetTrackUI
{
    partial class YardimForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            aktivitedurumu = new ReaLTaiizor.Controls.Panel();
            label16 = new Label();
            label15 = new Label();
            label18 = new Label();
            label17 = new Label();
            ...
            pictureBox10.Location = new Point(1062, 26);
            pictureBox10.Margin = new Padding(3, 2, 3, 2);
            pictureBox10.Name = "pictureBox10";
            pictureBox10.Size = new Size(22, 19);
            ...
            pictureBox8.Location = new Point(1196, 26);
            pictureBox8.Margin = new Padding(3, 2, 3, 2);
            pictureBox8.Name = "pictureBox8";
            pictureBox8.Size = new Size(22, 19);
            ...
            // aktivitedurumu
            // 
            aktivitedurumu.BackColor = SystemColors.ButtonFace;
            aktivitedurumu.Controls.Add(label16);
            aktivitedurumu.Controls.Add(label15);
            aktivitedurumu.Controls.Add(label18);
            aktivitedurumu.Controls.Add(label17);
            aktivitedurumu.Controls.Add(label14);
            aktivitedurumu.Controls.Add(label13);
            aktivitedurumu.Controls.Add(label12);
            aktivitedurumu.Controls.Add(label10);
            aktivitedurumu.Controls.Add(label11);
            aktivitedurumu.Controls.Add(label9);
            aktivitedurumu.EdgeColor = Color.White;
            aktivitedurumu.ImeMode = ImeMode.Disable;
            aktivitedurumu.Location = new Point(210, 130);
            aktivitedurumu.Margin = new Padding(3, 2, 3, 2);
            aktivitedurumu.Name = "aktivitedurumu";
            aktivitedurumu.Padding = new Padding(4);
            aktivitedurumu.Size = new Size(1018, 587);
            aktivitedurumu.SmoothingType = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
            aktivitedurumu.TabIndex = 9;
            aktivitedurumu.TabStop = false;
            aktivitedurumu.Text = "panel6";
            // 
            // label16
            // 
            label16.Font = new Font("Segoe UI Semibold", 13F, FontStyle.Bold);
            label16.Location = new Point(20, 495);
            label16.Name = "label16";
            label16.Size = new Size(854, 75);
            label16.TabIndex = 24;
            label16.Text = "Eklenen aktiviteler, aktiviteler sayfası üzerinden tablo halinde görüntülenebilir.";
            // 
            // label15
            // 
            label15.AutoSize = true;
            label15.Font = new Font("Segoe UI Semibold", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 162);
            label15.ForeColor = SystemColors.MenuHighlight;
            label15.Location = new Point(20, 458);
            label15.Name = "label15";
            label15.Size = new Size(359, 30);
            label15.TabIndex = 23;
            label15.Text = "Aktivite verileri nasıl görüntülenir?";
            // 
            // label18
            // 
            label18.Font = new Font("Segoe UI Semibold", 13F, FontStyle.Bold);
            label18.Location = new Point(20, 382);
            label18.Name = "label18";
            label18.Size = new Size(854, 75);
            label18.TabIndex = 22;
            label18.Text = "Ayarlar sayfasında yer alan “Şifre Değiştir” bölümünden mevcut şifrenizi girerek yeni bir şifre belirleyebilirsiniz.";
            // 
            // label17
            // 
            label17.AutoSize = true;
            label17.Font = new Font("Segoe UI Semibold", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 162);
            label17.ForeColor = SystemColors.MenuHighlight;
            label17.Location = new Point(20, 345);
            label17.Name = "label17";
            label17.Size = new Size(302, 30);
            label17.TabIndex = 21;
            label17.Text = "Şifremi nasıl değiştirebilirim?";
            // 
            // label14
            // 
            label14.Font = new Font("Segoe UI Semibold", 13F, FontStyle.Bold);
            label14.Location = new Point(20, 278);
            label14.Name = "label14";
            label14.Size = new Size(854, 75);
            label14.TabIndex = 18;
            label14.Text = "Evet. Hayvanlara ait bilgiler düzenleme ekranı üzerinden güncellenebilir.";
            // 
            // label13
            // 
            label13.AutoSize = true;
            label13.Font = new Font("Segoe UI Semibold", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 162);
            label13.ForeColor = SystemColors.MenuHighlight;
            label13.Location = new Point(20, 240);
            label13.Name = "label13";
            label13.Size = new Size(499, 30);
            label13.TabIndex = 17;
            label13.Text = "Hayvan bilgilerimi sonradan değiştirebilir miyim?";
            // 
            // label12
            // 
            ...
            label12.Size = new Size(854, 35);
            label12.TabIndex = 16;
            label12.Text = "Evet. Eklenen aktiviteler düzenlenebilir veya silinerek yeniden eklenebilir.";
            // 
            // label10
            // 
            label10.AutoSize = true;
            label10.Font = new Font("Segoe UI Semibold", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 162);
            label10.ForeColor = SystemColors.MenuHighlight;
            label10.Location = new Point(20, 135);
            label10.Name = "label10";
            label10.Size = new Size(500, 30);
            label10.TabIndex = 15;
            label10.Text = "Yanlış eklediğim bir aktiviteyi düzeltebilir miyim?";
            // 
            // label11
            // 
            ...
            label11.Size = new Size(854, 75);
            label11.TabIndex = 14;
            label11.Text = "Sisteme birden fazla evcil hayvan eklenebilir. Her hayvan için ayrı ayrı aktivite kayıtları tutulabilir.";
            // 
            // label9
            // 
            label9.AutoSize = true;
            label9.Font = new Font("Segoe UI Semibold", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 162);
            label9.ForeColor = SystemColors.MenuHighlight;
            label9.Location = new Point(20, 30);
            label9.Name = "label9";
            label9.Size = new Size(401, 30);
            label9.TabIndex = 12;
            label9.Text = "Sisteme kaç tane hayvan ekleyebilirim?";
            // 
            // label8
            // 
            label8.AutoSize = true;
            label8.Font = new Font("Segoe UI Semibold", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 162);
            label8.Location = new Point(210, 92);
            label8.Name = "label8";
            ...
            aktivitedurumu.ResumeLayout(false);
            aktivitedurumu.PerformLayout();
        ...
        private ReaLTaiizor.Controls.Panel aktivitedurumu;
